...
## Data 
The sample AOD data (16.nc, 17.nc) are placed at the [data](https://github.com/gz-wei/Physics-Informed-Statistical-Modeling-for-Wildfire-Aerosols-Process/tree/main/data) folder, and the complete AOD data can be obtained in the following way. 
