...
## Data 
The complete AOD data can be obtained in the following way, while the sample AOD data (16.nc, 17.nc) are placed at the [data](https://github.com/gz-wei/Physics-Informed-Statistical-Modeling-for-Wildfire-Aerosols-Process/tree/main/data) folder to test the codes. 
